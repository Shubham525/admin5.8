    ...
    <section id="wrapper">
        <div class="login-register"
            ...
            <div class="login-box card">
                <div class="card-body">
                    <?php echo e(Form::open(['url' => route('admin.login'), 'class'=>'form-horizontal form-material','method'=>'post', 'id'=>'loginform'])); ?>
                    ...
                    <?php if(session()->has('password_reset')): ?>
                        <div class="alert alert-info" role="alert">
                            <?php echo e(session()->get('password_reset')); ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <a href="<?php echo e(route('get-forget')); ?>" class="text-dark pull-right"><i class="fa fa-lock m-r-5"></i> Forgot pwd?</a>
                        </div>
                    </div>
...
</html><?php /**PATH /var/www/html/Chrome-Plugin/resources/views/auth/login.blade.php ENDPATH**/ ?>