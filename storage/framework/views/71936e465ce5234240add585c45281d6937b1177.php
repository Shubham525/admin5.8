...
<!-- footer -->
<!-- ============================================================== -->
<footer class="footer" style="left: 0px !important"> <?php echo e(env('APP_NAME')); ?> &copy; Copyright <?php echo e(date('Y')); ?>, All rights
	reserved </footer>
<!-- ============================================================== -->
<!-- End footer -->
<!-- ============================================================== -->
...
<script src="<?php echo e(asset('js/pnotify.custom.min.js')); ?>" type="text/javascript"></script>
<!-- Waitme JS -->
<script src="<?php echo e(asset('js/waitMe.min.js')); ?>" type="text/javascript"></script>

<!-- developer js common function functions -->
<script src="<?php echo e(asset('js/developer.js')); ?>" type="text/javascript"></script>
<script>
	$.ajaxSetup({
		    beforeSend: function() {
...
</html><?php /**PATH /var/www/html/Chrome-Plugin/resources/views/user/layouts/footer.blade.php ENDPATH**/ ?>