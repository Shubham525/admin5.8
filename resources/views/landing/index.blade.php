		...
		<div class="col-md-6 banner-matter">
					...
					<div id="owl-demo1" class="owl-carousel">
						<div class="item-bottom">
				            <div class="item-right">
								...
								<p>{{ env('APP_NAME') }} helps you browse smarter by giving you control over ads and tracking technologies to speed up page loads, eliminate clutter, and protect your data. </p>
			...
			<div class="col-md-6 banner-side">
					<div class="col-md-12 side">
						<img class="img-responsive" src="{{asset('landing/images/ba.png')}}" alt="">
					</div>
