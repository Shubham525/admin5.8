...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click','.csv-download',function(e){
            rows = [['Email','First Name','Last Name', 'Email Verified On','Date Created'],['{{Auth::user()->email}}','{{Auth::user()->first_name}}','{{Auth::user()->last_name}}','{{Auth::user()->email_verified_at}}', '{{Auth::user()->created_at}}']];
